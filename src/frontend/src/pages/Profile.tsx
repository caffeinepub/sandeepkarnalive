...
export function Profile() {
  ...
  const isAdmin = user.username === "sandeepkarna321";

  return (
    <div className="min-h-screen bg-mesh pt-20 pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Platform owner hero - visible to all */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="glass-card rounded-2xl p-6 mb-6 flex flex-col sm:flex-row items-center gap-5 ring-1 ring-gold/20"
        >
          <div className="relative shrink-0">
            <img
              src="/assets/uploads/IMG_20260303_214406-1.jpg"
              alt="Sandeep Karna"
              className="w-20 h-20 rounded-full object-cover border-4 border-gold shadow-[0_0_20px_rgba(255,182,0,0.35)]"
              onError={(e) => {
